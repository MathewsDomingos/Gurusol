!(function (t, e) {
    ...
    const l = (t) => {
        ...
        c = (t) => {
            ...
            if ("function" != typeof t.getRootNode) return t instanceof ShadowRoot ? t : t.parentNode ? c(t.parentNode) : null;
            t = t.getRootNode();
        ...
        t = (i, s) => {
            var t = () => {
                const t = m();
                var e;
                t && ((e = t.fn[i]), (t.fn[i] = s.jQueryInterface), (t.fn[i].Constructor = s), (t.fn[i].noConflict = () => ((t.fn[i] = e), s.jQueryInterface)));
            };
    ...
    var _ = function (t, e, i) {
        ...
        y = (t, e) => (v.has(t) && v.get(t).get(e)) || null,
        b = function (t, e) {
            if (v.has(t)) {
                const i = v.get(t);
    ...
    function L(t, e, i) {
        ...
        let n = t.replace(x, "");
        e = k[n];
        return e && (n = e), S.has(n) || (n = t), [s, i, n];
    }
    function z(t, e, i, s, n) {
        if ("string" == typeof e && t) {
                ...
                v = c
                    ? ((a = t),
                      ...
                      function i(s) {
                          ...
                          for (let { target: e } = s; e && e !== this; e = e.parentNode) for (let t = n.length; t--; ) if (n[t] === e) return (s.delegateTarget = e), i.oneOff && M.off(a, s.type, h), h.apply(e, [s]);
                          return null;
                      })
                    : ((o = t),
                      (r = i),
            ...
            var o, r, a, l, h;
            (v.delegationSelector = c ? i : null), (v.originalHandler = u), (v.oneOff = n), (v.uidEvent = g), (f[g] = v), t.addEventListener(d, v, c);
        }
    }
    ...
    const M = {
        ...
        off(r, a, t, e) {
            if ("string" == typeof a && r) {
                var [i, s, n] = L(a, t, e),
                    ...
                    l = O(r),
                    e = a.startsWith(".");
                if (void 0 !== s) return l && l[n] ? void D(r, l, n, s, i ? t : null) : void 0;
                e &&
                    Object.keys(l).forEach((t) => {
                        ...
                        (e = r),
                            ...
                            Object.keys(o).forEach((t) => {
                                if (t.includes(n)) {
                                    const n = o[t];
                                    D(e, i, s, n.originalHandler, n.delegationSelector);
                                }
                            });
                    });
                var h = l[n] || {};
                Object.keys(h).forEach((t) => {
                    ...
                    if (!o || a.includes(e)) {
                        const a = h[t];
                        D(r, l, n, a.originalHandler, a.delegationSelector);
                    }
                });
            }
        },
        trigger(t, e, i) {
            ...
            let a,
                ...
                u = null;
            return (
                o && s && ((a = s.Event(e, i)), s(t).trigger(a), (l = !a.isPropagationStopped()), (h = !a.isImmediatePropagationStopped()), (c = a.isDefaultPrevented())),
                r ? ((u = document.createEvent("HTMLEvents")), u.initEvent(n, l, !0)) : (u = new CustomEvent(e, { bubbles: l, cancelable: !0 })),
                void 0 !== i &&
    ...
    class P {
        constructor(t) {
            (t = "string" == typeof t ? document.querySelector(t) : t) && ((this._element = t), _(this._element, this.constructor.DATA_KEY, this));
        }
        dispose() {
            b(this._element, this.constructor.DATA_KEY), (this._element = null);
        }
        static getInstance(t) {
            return y(t, this.DATA_KEY);
        }
        static get VERSION() {
            return "5.0.0-beta3";
        }
    ...
    M.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', j.handleDismiss(new j())), t("alert", j);
    class N extends P {
        static get DATA_KEY() {
            return "bs.button";
        }
    ...
    const R = {
            ...
            getDataAttribute: (t, e) => W(t.getAttribute("data-bs-" + H(e))),
            offset(t) {
    ...
    class Y extends P {
        ...
        pause(t) {
            t || (this._isPaused = !0), $.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (s(this._element), this.cycle(!0)), clearInterval(this._interval), (this._interval = null);
        }
        cycle(t) {
            t || (this._isPaused = !1),
        ...
        _getConfig(t) {
            return (t = { ...B, ...t }), i("carousel", t, F), t;
        }
        _handleSwipe() {
            var t = Math.abs(this.touchDeltaX);
            t <= 40 || ((t = t / this.touchDeltaX), (this.touchDeltaX = 0), t && this._slide(0 < t ? Q : U));
        }
        _addEventListeners() {
        ...
        _addTouchEventListeners() {
            ...
            $.find(".carousel-item img", this._element).forEach((t) => {
                ...
                this._pointerEvent
                    ? (M.on(this._element, "pointerdown.bs.carousel", (t) => e(t)), M.on(this._element, "pointerup.bs.carousel", (t) => s(t)), this._element.classList.add("pointer-event"))
                    : (M.on(this._element, "touchstart.bs.carousel", (t) => e(t)), M.on(this._element, "touchmove.bs.carousel", (t) => i(t)), M.on(this._element, "touchend.bs.carousel", (t) => s(t)));
        }
        _keydown(t) {
            /input|textarea/i.test(t.target.tagName) || ("ArrowLeft" === t.key ? (t.preventDefault(), this._slide(U)) : "ArrowRight" === t.key && (t.preventDefault(), this._slide(Q)));
        }
        _getItemIndex(t) {
        ...
        _triggerSlideEvent(t, e) {
            var i = this._getItemIndex(t),
                s = this._getItemIndex($.findOne(".active.carousel-item", this._element));
            return M.trigger(this._element, "slide.bs.carousel", { relatedTarget: t, direction: e, from: s, to: i });
        }
        ...
        _slide(t, e) {
            const i = this._directionToOrder(t),
                s = $.findOne(".active.carousel-item", this._element),
            ...
            if (o && o.classList.contains("active")) this._isSliding = !1;
            else if (!this._triggerSlideEvent(o, u).defaultPrevented && s && o) {
                if (((this._isSliding = !0), a && this.pause(), this._setActiveIndicatorElement(o), (this._activeElement = o), this._element.classList.contains("slide"))) {
                    o.classList.add(c), f(o), s.classList.add(h), o.classList.add(h);
                    const t = d(s);
                    M.one(s, "transitionend", () => {
                        o.classList.remove(h, c),
                            o.classList.add("active"),
                            s.classList.remove("active", c, h),
                            (this._isSliding = !1),
                            setTimeout(() => {
                                M.trigger(this._element, "slid.bs.carousel", { relatedTarget: o, direction: u, from: n, to: r });
                            }, 0);
                    }),
                        p(s, t);
                } else s.classList.remove("active"), o.classList.add("active"), (this._isSliding = !1), M.trigger(this._element, "slid.bs.carousel", { relatedTarget: o, direction: u, from: n, to: r });
                a && this.cycle();
            }
        }
        _directionToOrder(t) {
            return [Q, U].includes(t) ? (g() ? (t === Q ? V : q) : t === Q ? q : V) : t;
        }
        _orderToDirection(t) {
            return [q, V].includes(t) ? (g() ? (t === q ? U : Q) : t === q ? Q : U) : t;
        }
        static carouselInterface(t, e) {
            let i = y(t, "bs.carousel"),
                s = { ...B, ...R.getDataAttributes(t) };
        ...
        static dataApiClickHandler(t) {
            ...
            if (e && e.classList.contains("carousel")) {
                const i = { ...R.getDataAttributes(e), ...R.getDataAttributes(this) },
                    s = this.getAttribute("data-bs-slide-to");
                s && (i.interval = !1), Y.carouselInterface(e, i), s && y(e, "bs.carousel").to(s), t.preventDefault();
            }
        }
    }
    M.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", Y.dataApiClickHandler),
        M.on(window, "load.bs.carousel.data-api", () => {
            var i = $.find('[data-bs-ride="carousel"]');
            for (let t = 0, e = i.length; t < e; t++) Y.carouselInterface(i[t], y(i[t], "bs.carousel"));
        }),
        t("carousel", Y);
    var K = { toggle: !0, parent: "" },
    ...
    class G extends P {
        constructor(t, i) {
            super(t),
                ...
                (this._triggerArray = $.find(`[data-bs-toggle="collapse"][href="#${this._element.id}"],[data-bs-toggle="collapse"][data-bs-target="#${this._element.id}"]`));
            var s = $.find('[data-bs-toggle="collapse"]');
            for (let t = 0, e = s.length; t < e; t++) {
                const i = s[t],
                    n = r(i),
                    o = $.find(n).filter((t) => t === this._element);
        ...
        show() {
            if (!this._isTransitioning && !this._element.classList.contains("show")) {
                let t, e;
                this._parent &&
                    ((t = $.find(".show, .collapsing", this._parent).filter((t) => ("string" == typeof this._config.parent ? t.getAttribute("data-bs-parent") === this._config.parent : t.classList.contains("collapse")))),
                    0 === t.length && (t = null));
                var i = $.findOne(this._selector);
                if (t) {
                    const o = t.find((t) => i !== t);
                    if (((e = o ? y(o, "bs.collapse") : null), e && e._isTransitioning)) return;
                }
                if (!M.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                    t &&
                        t.forEach((t) => {
                            i !== t && G.collapseInterface(t, "hide"), e || _(t, "bs.collapse", null);
                        });
        ...
        _getConfig(t) {
            return ((t = { ...K, ...t }).toggle = Boolean(t.toggle)), i("collapse", t, Z), t;
        }
        _getDimension() {
        ...
        _getParent() {
            ...
            a(t) ? (void 0 === t.jquery && void 0 === t[0]) || (t = t[0]) : (t = $.findOne(t));
        ...
        static collapseInterface(t, e) {
            let i = y(t, "bs.collapse");
            const s = { ...K, ...R.getDataAttributes(t), ...("object" == typeof e && e ? e : {}) };
            if ((!i && s.toggle && "string" == typeof e && /show|hide/.test(e) && (s.toggle = !1), (i = i || new G(t, s)), "string" == typeof e)) {
    ...
    M.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', function (t) {
        ...
        var s = R.getDataAttributes(this),
            t = r(this);
        $.find(t).forEach((t) => {
            const e = y(t, "bs.collapse");
            let i;
            (i = e ? (null === e._parent && "string" == typeof s.parent && ((e._config.parent = s.parent), (e._parent = e._getParent())), "toggle") : s), G.collapseInterface(t, i);
        });
    }),
        t("collapse", G);
    var X = "top",
        ...
        et = "left",
        it = [X, J, tt, et],
        st = it.reduce(function (t, e) {
            return t.concat([e + "-start", e + "-end"]);
        }, []),
        nt = [].concat(it, ["auto"]).reduce(function (t, e) {
    ...
    function _t(t) {
        return "html" === rt(t) ? t : t.assignedSlot || t.parentNode || (ct(t) ? t.host : null) || vt(t);
    }
    function yt(t) {
        return ht(t) && "fixed" !== gt(t).position ? t.offsetParent : null;
    }
    function bt(t) {
        for (var e = at(t), i = yt(t); i && 0 <= ["table", "td", "th"].indexOf(rt(i)) && "static" === gt(i).position; ) i = yt(i);
        return (
            ((!i || ("html" !== rt(i) && ("body" !== rt(i) || "static" !== gt(i).position))) &&
                (i ||
                    (function (t) {
                        for (var e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox"), i = _t(t); ht(i) && ["html", "body"].indexOf(rt(i)) < 0; ) {
                            var s = gt(i);
                            if (
                                "none" !== s.transform ||
                                "none" !== s.perspective ||
    ...
    var At = {
            ...
            fn: function (t) {
                var e,
                    ...
                    l = dt(s.placement),
                    h = wt(l),
                    c = 0 <= [et, tt].indexOf(l) ? "height" : "width";
                r &&
                    a &&
                    ((e = kt("number" != typeof (i = "function" == typeof (i = o.padding) ? i(Object.assign({}, s.rects, { placement: s.placement })) : i) ? i : St(i, it))),
                    (t = ft(r)),
                    (l = "y" === h ? X : et),
                    (o = "y" === h ? J : tt),
                    (i = s.rects.reference[c] + s.rects.reference[h] - a[h] - s.rects.popper[c]),
                    (a = a[h] - s.rects.reference[h]),
                    (r = (r = bt(r)) ? ("y" === h ? r.clientHeight || 0 : r.clientWidth || 0) : 0),
                    (a = i / 2 - a / 2),
                    (l = e[l]),
                    (o = r - t[c] - e[o]),
                    (o = Tt(l, (a = r / 2 - t[c] / 2 + a), o)),
                    (s.modifiersData[n] = (((n = {})[h] = o), (n.centerOffset = o - a), n)));
            },
            effect: function (t) {
                var e = t.state,
                    t = t.options.element,
    ...
    function It(t) {
        var e,
            ...
            c = t.adaptive,
            u = t.roundOffsets,
            d = !0 === u ? ((e = a.x), (i = a.y), (s = window.devicePixelRatio || 1), { x: Et(Et(e * s) / s) || 0, y: Et(Et(i * s) / s) || 0 }) : "function" == typeof u ? u(a) : a,
            p = d.x,
            f = void 0 === p ? 0 : p,
            m = d.y,
            t = void 0 === m ? 0 : m,
        ...
        c &&
            ((d = "clientHeight"),
            (m = "clientWidth"),
            (a = bt(n)) === at(n) && "static" !== gt((a = vt(n))).position && ((d = "scrollHeight"), (m = "scrollWidth")),
            r === X && ((u = J), (t -= a[d] - o.height), (t *= h ? 1 : -1)),
            r === et && ((s = tt), (f -= a[m] - o.width), (f *= h ? 1 : -1)));
        var c = Object.assign({ position: l }, c && Ot);
        return h
            ? Object.assign({}, c, (((h = {})[u] = i ? "0" : ""), (h[s] = e ? "0" : ""), (h.transform = (p.devicePixelRatio || 1) < 2 ? "translate(" + f + "px, " + t + "px)" : "translate3d(" + f + "px, " + t + "px, 0)"), h))
            : Object.assign({}, c, (((c = {})[u] = i ? t + "px" : ""), (c[s] = e ? f + "px" : ""), (c.transform = ""), c));
    }
    var Lt = {
            name: "computeStyles",
            enabled: !0,
            ...
            fn: function (t) {
                ...
                null != e.modifiersData.popperOffsets &&
                    (e.styles.popper = Object.assign({}, e.styles.popper, It(Object.assign({}, t, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: s, roundOffsets: i })))),
                    null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, It(Object.assign({}, t, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: i })))),
                ...
                return (
                    n &&
                        a.forEach(function (t) {
                            t.addEventListener("scroll", i.update, zt);
                        }),
                    o && r.addEventListener("resize", i.update, zt),
                    function () {
                        n &&
                            a.forEach(function (t) {
                                t.removeEventListener("scroll", i.update, zt);
                            }),
                            o && r.removeEventListener("resize", i.update, zt);
                    }
                );
            },
            data: {},
    ...
    function $t(t, e) {
        void 0 === e && (e = []);
        var i = (function t(e) {
                return 0 <= ["html", "body", "#document"].indexOf(rt(e)) ? e.ownerDocument.body : ht(e) && Rt(e) ? e : t(_t(e));
            })(t),
            t = i === (null == (s = t.ownerDocument) ? void 0 : s.body),
            s = at(i),
            i = t ? [s].concat(s.visualViewport || [], Rt(i) ? i : []) : i,
            e = e.concat(i);
        return t ? e : e.concat($t(_t(i)));
    }
    function Bt(t) {
    ...
    function Ft(t, e) {
        return "viewport" === e
            ? Bt(
                  ...
                  (h = r.clientHeight),
                  (r = o = 0),
                  a && ((l = a.width), (h = a.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((o = a.offsetLeft), (r = a.offsetTop))),
                  { width: l, height: h, x: o + Ht(n), y: r })
              )
            : ht(e)
            ? (((s = pt((i = e))).top = s.top + i.clientTop),
            ...
            : Bt(
                  ...
                  (t = xt(r.scrollWidth, r.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0)),
                  (i = xt(r.scrollHeight, r.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0)),
                  (n = -e.scrollLeft + Ht(n)),
                  (e = -e.scrollTop),
                  "rtl" === gt(s || r).direction && (n += xt(r.clientWidth, s ? s.clientWidth : 0) - t),
    ...
    function Ut(t, e) {
        var i,
            ...
            h = e.padding,
            u = void 0 === h ? 0 : h,
            o = kt("number" != typeof u ? u : St(u, it)),
            e = "popper" === d ? "reference" : "popper",
            h = t.elements.reference,
            u = t.rects.popper,
            a = t.elements[a ? e : d],
            a =
                ((i = lt(a) ? a : a.contextElement || vt(t.elements.popper)),
                (e = c),
                (a =
                    "clippingParents" === (a = l)
                        ? ((l = $t(_t((c = i)))),
                          lt((s = 0 <= ["absolute", "fixed"].indexOf(gt(c).position) && ht(c) ? bt(c) : c))
                              ? l.filter(function (t) {
                                    return lt(t) && mt(t, s) && "body" !== rt(t);
                                })
                              : [])
                        : [].concat(a)),
                (a = [].concat(a, [e])),
                ...
                }, Ft(i, e))).width = e.right - e.left),
                (e.height = e.bottom - e.top),
                (e.x = e.left),
                (e.y = e.top),
                e),
            e = pt(h),
            h = Vt({ reference: e, element: u, strategy: "absolute", placement: r }),
            h = Bt(Object.assign({}, u, h)),
            e = "popper" === d ? h : e,
            p = { top: a.top - e.top + o.top, bottom: e.bottom - a.bottom + o.bottom, left: a.left - e.left + o.left, right: e.right - a.right + o.right },
            ...
            if (!u.modifiersData[i]._skip) {
                for (
                    var s = e.mainAxis,
                        ...
                        a = [t].concat(e).reduce(function (t, e) {
                            return t.concat(
                                "auto" === dt(e)
                                    ? ((i = u),
                                      (n = (s = void 0 === (s = { placement: e, boundary: p, rootBoundary: f, padding: d, flipVariations: m, allowedAutoPlacements: g }) ? {} : s).placement),
                                      (o = s.boundary),
                                      (r = s.rootBoundary),
                                      (a = s.padding),
                                      (t = s.flipVariations),
                                      (l = void 0 === (s = s.allowedAutoPlacements) ? nt : s),
                                      (h = qt(n)),
                                      (n = h
                                          ? t
                                              ? st
                    ...
                    var b = a[y],
                        ...
                        C = 0 <= [X, J].indexOf(w),
                        E = C ? "width" : "height",
                        T = Ut(u, { placement: b, boundary: p, rootBoundary: f, altBoundary: r, padding: d }),
                        C = C ? (x ? tt : et) : x ? J : X;
                    l[E] > h[E] && (C = Pt(C));
                    (x = Pt(C)), (E = []);
                    if (
                ...
                u.placement !== _ && ((u.modifiersData[i]._skip = !0), (u.placement = _), (u.reset = !0));
            }
        },
    ...
    function Kt(e) {
        return [X, tt, J, et].some(function (t) {
            return 0 <= e[t];
        });
    }
    var Zt = {
            ...
            fn: function (t) {
                var e = t.state,
                    ...
                    n = Kt(s),
                    o = Kt(t);
                (e.modifiersData[i] = { referenceClippingOffsets: s, popperEscapeOffsets: t, isReferenceHidden: n, hasPopperEscaped: o }),
                    (e.attributes.popper = Object.assign({}, e.attributes.popper, { "data-popper-reference-hidden": n, "data-popper-escaped": o }));
            },
        },
        Gt = {
            name: "offset",
            ...
            fn: function (t) {
                var r = t.state,
                    ...
                    t = nt.reduce(function (t, e) {
                        return (
                            (t[e] =
                                ...
                                (n = a),
                                (o = dt(i)),
                                (e = 0 <= [et, X].indexOf(o) ? -1 : 1),
                                (n = (n = (i = "function" == typeof n ? n(Object.assign({}, s, { placement: i })) : n)[0]) || 0),
                                (i = ((i = i[1]) || 0) * e),
                                0 <= [et, tt].indexOf(o) ? { x: i, y: n } : { x: n, y: i })),
                            t
                        );
                        var i, s, n, o;
                    }, {}),
                    ...
                    s = e.x,
                    e = e.y;
                null != r.modifiersData.popperOffsets && ((r.modifiersData.popperOffsets.x += s), (r.modifiersData.popperOffsets.y += e)), (r.modifiersData[i] = t);
            },
        },
        Xt = {
            name: "popperOffsets",
        ...
        Jt = {
            ...
            fn: function (t) {
                var e = t.state,
                    ...
                    f = i.tetherOffset,
                    m = void 0 === f ? 0 : f,
                    g = Ut(e, { boundary: l, rootBoundary: h, padding: u, altBoundary: c }),
                    v = dt(e.placement),
                    _ = qt(e.placement),
                    y = !_,
                    b = wt(v),
                    ...
                    C = e.rects.reference,
                    t = e.rects.popper,
                    n = "function" == typeof m ? m(Object.assign({}, e.rects, { placement: e.placement })) : m,
                    r = { x: 0, y: 0 };
                x &&
                    ((o || a) &&
                        ((d = "y" === b ? X : et),
                        ...
                        (m = "start" === _ ? -t[f] : -C[f]),
                        (_ = e.elements.arrow),
                        (t = p && _ ? ft(_) : { width: 0, height: 0 }),
                        (d = (_ = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 })[d]),
                        (i = _[i]),
                        (t = Tt(0, C[f], t[f])),
                        (d = y ? C[f] / 2 - c - t - d - n : v - t - d - n),
                        (t = y ? -C[f] / 2 + c + t + i + n : m + t + i + n),
                        (n = (i = e.elements.arrow && bt(e.elements.arrow)) ? ("y" === b ? i.clientTop || 0 : i.clientLeft || 0) : 0),
                        (i = e.modifiersData.offset ? e.modifiersData.offset[e.placement][b] : 0),
                        (n = x[b] + d - i - n),
                        (i = x[b] + t - i),
                        o && ((u = Tt(p ? Ct(h, n) : h, l, p ? xt(u, i) : u)), (x[b] = u), (r[b] = u - l)),
                        a && ((l = "x" === b ? X : et), (a = "x" === b ? J : tt), (l = (b = x[w]) + g[l]), (a = b - g[a]), (a = Tt(p ? Ct(l, n) : l, b, p ? xt(a, i) : a)), (x[w] = a), (r[w] = a - b))),
                    (e.modifiersData[s] = r));
            },
            requiresIfExists: ["offset"],
        };
            ...
            var i,
                ...
                u = {
                    ...
                    setOptions: function (t) {
                        d(), (l.options = Object.assign({}, f, l.options, t)), (l.scrollParents = { reference: lt(r) ? $t(r) : r.contextElement ? $t(r.contextElement) : [], popper: $t(a) });
                        var e,
                            i,
                            s,
                            n,
                        ...
                        return (
                            ...
                            l.orderedModifiers.forEach(function (t) {
                                var e = t.name,
                                    ...
                                    i = void 0 === i ? {} : i,
                                    t = t.effect;
                                "function" == typeof t && ((i = t({ state: l, name: e, instance: u, options: i })), h.push(i || function () {}));
                            }),
                            u.update()
                        );
                    },
                            ...
                            if (ee(e, t)) {
                                (l.rects = {
                                    reference: (function (t, e, i) {
                                        ...
                                        return (
                                            (!o && (o || i)) ||
                                                (("body" === rt(e) && !Rt(s)) || (r = (i = e) !== at(i) && ht(i) ? { scrollLeft: i.scrollLeft, scrollTop: i.scrollTop } : Wt(i)),
                                                ht(e) ? (((t = pt(e)).x += e.clientLeft), (t.y += e.clientTop)) : s && (t.x = Ht(s))),
                                            { x: n.left + r.scrollLeft - t.x, y: n.top + r.scrollTop - t.y, width: n.width, height: n.height }
                                        );
                                ...
                                for (var i, s, n, o = 0; o < l.orderedModifiers.length; o++)
                                    !0 !== l.reset
                                        ? ((i = (n = l.orderedModifiers[o]).fn), (s = void 0 === (s = n.options) ? {} : s), (n = n.name), "function" == typeof i && (l = i({ state: l, options: s, name: n, instance: u }) || l))
                                        : ((l.reset = !1), (o = -1));
                            }
                        }
                    },
    ...
    var se = ie(),
        ne = ie({ defaultModifiers: [Dt, Xt, Lt, ut] }),
        oe = ie({ defaultModifiers: [Dt, Xt, Lt, ut, Gt, Qt, Jt, At, Zt] }),
        re = Object.freeze({
            __proto__: null,
            popperGenerator: ie,
            detectOverflow: Ut,
    ...
    const ae = new RegExp("ArrowUp|ArrowDown|Escape"),
        ...
        he = g() ? "top-start" : "top-end",
        ce = g() ? "bottom-end" : "bottom-start",
        ue = g() ? "bottom-start" : "bottom-end",
    ...
    class ge extends P {
        ...
        show() {
            if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                ...
                if (!M.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                    if (this._inNavbar) R.setDataAttribute(this._menu, "popper", "none");
                    else {
                        ...
                        (this._popper = oe(t, this._menu, i)), s && R.setDataAttribute(this._menu, "popper", "static");
                    }
        ...
        hide() {
            ...
            this._element.disabled ||
                ...
                M.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented ||
                    (this._popper && this._popper.destroy(), this._menu.classList.toggle("show"), this._element.classList.toggle("show"), R.removeDataAttribute(this._menu, "popper"), M.trigger(this._element, "hidden.bs.dropdown", t)));
        }
        dispose() {
        ...
        _getConfig(t) {
            if (
                ((t = { ...this.constructor.Default, ...R.getDataAttributes(this._element), ...t }),
        ...
        _getPlacement() {
            ...
            return t.classList.contains("dropup") ? (e ? he : le) : e ? ue : ce;
        }
        _detectNavbar() {
        ...
        static clearMenus(i) {
            ...
            const s = $.find('[data-bs-toggle="dropdown"]');
            for (let t = 0, e = s.length; t < e; t++) {
                const n = y(s[t], "bs.dropdown"),
                    o = { relatedTarget: s[t] };
                if ((i && "click" === i.type && (o.clickEvent = i), n)) {
                    const r = n._menu;
                    if (s[t].classList.contains("show")) {
                        if (i) {
                            if ([n._element].some((t) => i.composedPath().includes(t))) continue;
                            if ("keyup" === i.type && "Tab" === i.key && r.contains(i.target)) continue;
                        }
                        M.trigger(s[t], "hide.bs.dropdown", o).defaultPrevented ||
                            ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((t) => M.off(t, "mouseover", null, function () {})),
                            s[t].setAttribute("aria-expanded", "false"),
                            n._popper && n._popper.destroy(),
                            r.classList.remove("show"),
                            s[t].classList.remove("show"),
                            R.removeDataAttribute(r, "popper"),
                            M.trigger(s[t], "hidden.bs.dropdown", o));
                    }
                }
            }
        }
        ...
        static dataApiKeydownHandler(e) {
            if (
                ...
                if ("Escape" === e.key) return (this.matches('[data-bs-toggle="dropdown"]') ? this : $.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(), void ge.clearMenus();
                if (i || ("ArrowUp" !== e.key && "ArrowDown" !== e.key))
                    if (i && "Space" !== e.key) {
                        const s = $.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", t).filter(o);
                        if (s.length) {
                            let t = s.indexOf(e.target);
                            "ArrowUp" === e.key && 0 < t && t--, "ArrowDown" === e.key && t < s.length - 1 && t++, (t = -1 === t ? 0 : t), s[t].focus();
                        }
                    } else ge.clearMenus();
                else (this.matches('[data-bs-toggle="dropdown"]') ? this : $.prev(this, '[data-bs-toggle="dropdown"]')[0]).click();
            }
        }
    }
    ...
    class ye extends P {
        ...
        _showElement(t) {
            ...
            if (e) {
                ...
                M.one(this._dialog, "transitionend", s), p(this._dialog, t);
            } else s();
        }
        _enforceFocus() {
            M.off(document, "focusin.bs.modal"),
        ...
        _setElementAttributes(t, s, n) {
            $.find(t).forEach((t) => {
                var e, i;
                (t !== document.body && window.innerWidth > t.clientWidth + this._scrollbarWidth) || ((e = t.style[s]), (i = window.getComputedStyle(t)[s]), R.setDataAttribute(t, s, e), (t.style[s] = n(Number.parseFloat(i)) + "px"));
            });
        }
        _resetScrollbar() {
        ...
        _resetElementAttributes(t, i) {
            $.find(t).forEach((t) => {
                var e = R.getDataAttribute(t, i);
                void 0 === e && t === document.body ? (t.style[i] = "") : (R.removeDataAttribute(t, i), (t.style[i] = e));
            });
        }
        _getScrollbarWidth() {
        ...
        static jQueryInterface(i, s) {
            return this.each(function () {
                let t = y(this, "bs.modal");
                var e = { ...ve, ...R.getDataAttributes(this), ...("object" == typeof i && i ? i : {}) };
                if (((t = t || new ye(this, e)), "string" == typeof i)) {
    ...
    M.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', function (t) {
        ...
        let i = y(e, "bs.modal");
        if (!i) {
            const t = { ...R.getDataAttributes(e), ...R.getDataAttributes(this) };
            i = new ye(e, t);
        }
        i.toggle(this);
    }),
    ...
    var be = () => {
        ...
        we = (t, s, n) => {
            ...
            $.find(t).forEach((t) => {
                var e, i;
                (t !== document.body && window.innerWidth > t.clientWidth + o) || ((e = t.style[s]), (i = window.getComputedStyle(t)[s]), R.setDataAttribute(t, s, e), (t.style[s] = n(Number.parseFloat(i)) + "px"));
            });
        },
        xe = (t, i) => {
            $.find(t).forEach((t) => {
                var e = R.getDataAttribute(t, i);
                void 0 === e && t === document.body ? t.style.removeProperty(i) : (R.removeDataAttribute(t, i), (t.style[i] = e));
            });
        },
    ...
    class Te extends P {
        ...
        _getConfig(t) {
            return (t = { ...Ce, ...R.getDataAttributes(this._element), ...("object" == typeof t ? t : {}) }), i("offcanvas", t, Ee), t;
        }
        ...
        _addEventListeners() {
            M.on(this._element, "click.dismiss.bs.offcanvas", '[data-bs-dismiss="offcanvas"]', () => this.hide()),
                ...
                M.on(document, "click.bs.offcanvas.data-api", (t) => {
                    var e = $.findOne(r(t.target));
                    this._element.contains(t.target) || e === this._element || this.hide();
                });
        }
        static jQueryInterface(e) {
            return this.each(function () {
                const t = y(this, "bs.offcanvas") || new Te(this, "object" == typeof e ? e : {});
                if ("string" == typeof e) {
    ...
    M.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function (t) {
        ...
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
            h(this) ||
                ...
                ((t = $.findOne(".offcanvas.show, .offcanvas-toggling")) && t !== e) || (y(e, "bs.offcanvas") || new Te(e)).toggle(this));
    }),
        M.on(window, "load.bs.offcanvas.data-api", () => {
            $.find(".offcanvas.show").forEach((t) => (y(t, "bs.offcanvas") || new Te(t)).show());
        }),
        t("offcanvas", Te);
            ...
            if (o.includes(n)) {
                ...
                a.forEach((t) => {
                    ((t, e) => {
                        ...
                        if (e.includes(i)) return !ke.has(i) || Boolean(Se.test(t.nodeValue) || Ae.test(t.nodeValue));
    ...
    const Ie = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
        ...
        De = { AUTO: "auto", TOP: "top", RIGHT: g() ? "left" : "right", BOTTOM: "bottom", LEFT: g() ? "right" : "left" },
        Me = {
            animation: !0,
    ...
    class je extends P {
        ...
        show() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                if (!e.defaultPrevented && s) {
                    ...
                    var t = "function" == typeof this.config.placement ? this.config.placement.call(this, n, this._element) : this.config.placement,
                        t = this._getAttachment(t);
                    this._addAttachmentClass(t);
                    const r = this._getContainer();
                    _(n, this.constructor.DATA_KEY, this),
                        this._element.ownerDocument.documentElement.contains(this.tip) || (r.appendChild(n), M.trigger(this._element, this.constructor.Event.INSERTED)),
                        this._popper ? this._popper.update() : (this._popper = oe(this._element, n, this._getPopperConfig(t))),
        ...
        hide() {
            if (this._popper) {
                ...
                M.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented ||
                    ...
                    "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((t) => M.off(t, "mouseover", u)),
        ...
        setContent() {
            ...
            this.setElementContent($.findOne(".tooltip-inner", t), this.getTitle()), t.classList.remove("fade", "show");
        }
        ...
        _initializeOnDelegatedTarget(t, e) {
            ...
            return (e = e || y(t.delegateTarget, i)) || ((e = new this.constructor(t.delegateTarget, this._getDelegateConfig())), _(t.delegateTarget, i, e)), e;
        }
        _getOffset() {
        ...
        static jQueryInterface(i) {
            return this.each(function () {
                let t = y(this, "bs.tooltip");
                var e = "object" == typeof i && i;
                if ((t || !/dispose|hide/.test(i)) && ((t = t || new je(this, e)), "string" == typeof i)) {
                    if (void 0 === t[i]) throw new TypeError(`No method named "${i}"`);
                    t[i]();
                }
            });
    ...
    class $e extends je {
        ...
        setContent() {
            const t = this.getTipElement();
            this.setElementContent($.findOne(".popover-header", t), this.getTitle());
            let e = this._getContent();
            "function" == typeof e && (e = e.call(this._element)), this.setElementContent($.findOne(".popover-body", t), e), t.classList.remove("fade", "show");
        }
        _addAttachmentClass(t) {
        ...
        static jQueryInterface(i) {
            return this.each(function () {
                let t = y(this, "bs.popover");
                var e = "object" == typeof i ? i : null;
                if ((t || !/dispose|hide/.test(i)) && (t || ((t = new $e(this, e)), _(this, "bs.popover", t)), "string" == typeof i)) {
                    if (void 0 === t[i]) throw new TypeError(`No method named "${i}"`);
                    t[i]();
                }
            });
    ...
    class qe extends P {
                ...
                $.find(this._selector)
                    .map((t) => {
                        ...
                        if (i) {
                            ...
                            if (t.width || t.height) return [R[s](i).top + n, e];
                        }
                        return null;
                    })
                    .filter((t) => t)
        ...
        _getConfig(e) {
            if ("string" != typeof (e = { ...Be, ...("object" == typeof e && e ? e : {}) }).target && a(e.target)) {
                let { id: t } = e.target;
                t || ((t = l("scrollspy")), (e.target.id = t)), (e.target = "#" + t);
            }
            return i("scrollspy", e, Fe), e;
        }
        _getScrollTop() {
    ...
    M.on(window, "load.bs.scrollspy.data-api", () => {
        $.find('[data-bs-spy="scroll"]').forEach((t) => new qe(t, R.getDataAttributes(t)));
    }),
        t("scrollspy", qe);
    class Ve extends P {
        static get DATA_KEY() {
        ...
        show() {
            if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active")) || h(this._element))) {
                let t;
                const i = n(this._element),
                    s = this._element.closest(".nav, .list-group");
                if (s) {
                    const i = "UL" === s.nodeName || "OL" === s.nodeName ? ":scope > li > .active" : ".active";
                    (t = $.find(i, s)), (t = t[t.length - 1]);
                }
        ...
        _activate(t, e, i) {
            const s = (!e || ("UL" !== e.nodeName && "OL" !== e.nodeName) ? $.children(e, ".active") : $.find(":scope > li > .active", e))[0],
                n = i && s && s.classList.contains("fade"),
                o = () => this._transitionComplete(t, s, i);
            if (s && n) {
                const t = d(s);
                s.classList.remove("show"), M.one(s, "transitionend", o), p(s, t);
            } else o();
        }
        _transitionComplete(t, e, i) {
            ...
            t.classList.add("active"),
                ...
                t.parentNode && t.parentNode.classList.contains("dropdown-menu") && (t.closest(".dropdown") && $.find(".dropdown-toggle").forEach((t) => t.classList.add("active")), t.setAttribute("aria-expanded", !0)),
                i && i();
        }
        static jQueryInterface(e) {
            return this.each(function () {
                const t = y(this, "bs.tab") || new Ve(this);
                if ("string" == typeof e) {
                    if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
                    t[e]();
                }
    ...
    M.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', function (t) {
        t.preventDefault(), (y(this, "bs.tab") || new Ve(this)).show();
    }),
        t("tab", Ve);
    ...
    class Ye extends P {
        ...
        _getConfig(t) {
            return (t = { ...Qe, ...R.getDataAttributes(this._element), ...("object" == typeof t && t ? t : {}) }), i("toast", t, this.constructor.DefaultType), t;
        }
        _setListeners() {
    ...
    return t("toast", Ye), { Alert: j, Button: N, Carousel: Y, Collapse: G, Dropdown: ge, Modal: ye, Offcanvas: Te, Popover: $e, ScrollSpy: qe, Tab: Ve, Toast: Ye, Tooltip: je };
}),
    (function (t, e) {
    ...
    (function (t, e) {
        ...
        function m(t) {
            if (
                ...
                for (var s = (i.isBorderBox = "border-box" == e.boxSizing), n = 0; n < _; n++) {
                    var o = v[n],
                        r = e[o],
                        r = parseFloat(r);
                    i[o] = isNaN(r) ? 0 : r;
            ...
            (t._transitionTo = function (t, e) {
                ...
                this.setPosition(t, e),
                    !n || this.isTransitioning
                        ? ((i = t - i), (e -= s), ((s = {}).transform = this.getTranslate(i, e)), this.transition({ to: s, onTransitionEnd: { transform: this.layoutPosition }, isCleaning: !0 }))
                        : this.layoutPosition();
            }),
        ...
        (c.cleanData =
            ...
            (c.widget = function (t, i, e) {
                ...
                return (
                    ...
                    (n.prototype = c.widget.extend(o, { widgetEventPrefix: (s && o.widgetEventPrefix) || t }, r, { constructor: n, namespace: a, widgetName: t, widgetFullName: l })),
                    s
                    ...
                    return (
                        t
                            ...
                            : (s.length && (i = c.widget.extend.apply(null, [i].concat(s))),
                              this.each(function () {
                                  var t = c.data(this, r);
                                  t ? (t.option(i || {}), t._init && t._init()) : c.data(this, r, new e(i, this));
                              })),
                        n
                    );
                };
            ...
            (c.Widget.prototype = {
                ...
                _classes: function (n) {
                    function t(t, e) {
                        for (var i, s = 0; t.length > s; s++)
                            (i = r.classesElementLookup[t[s]] || c()),
                ...
                _on: function (n, o, t) {
                    ...
                    "boolean" != typeof n && ((t = o), (o = n), (n = !1)),
                        t ? ((o = r = c(o)), (this.bindings = this.bindings.add(o))) : ((t = o), (o = this.element), (r = this.widget())),
                        c.each(t, function (t, e) {
                            function i() {
                                return n || (!0 !== a.options.disabled && !c(this).hasClass("ui-state-disabled")) ? ("string" == typeof e ? a[e] : e).apply(a, arguments) : void 0;
                            }
            ...
            c.each({ show: "fadeIn", hide: "fadeOut" }, function (o, r) {
                c.Widget.prototype["_" + o] = function (e, t, i) {
                    var s,
                        n = (t = "string" == typeof t ? { effect: t } : t) ? (!0 !== t && "number" != typeof t && t.effect) || r : o;
                ...
                _mouseCapture: function (t) {
                    ...
                    return (
                        ...
                        this.handles.each(function (t) {
                            ...
                            (e < s || (s === e && (t === a._lastChangedValue || a.values(t) === l.min))) && ((s = e), (n = c(this)), (o = t));
                        }),
                        !1 !== this._start(t, o) &&
                ...
                return (
                    h(this).each(function (t, e) {
                        var n = h(e),
                            ...
                            a = h.extend({ url: n.attr("action"), language: "en" }, i),
                        ...
                        n.attr("novalidate", "true"),
                            ...
                            n.submit(function () {
                                    ...
                                    h.ajax({
                                        ...
                                        success: function (e) {
                                            ...
                                            "en" !== a.language &&
                                                ...
                                                h.ajaxChimp.translations[a.language] &&
                                                h.ajaxChimp.translations[a.language][h.ajaxChimp.responses[i]] &&
                                                (i = h.ajaxChimp.translations[a.language][h.ajaxChimp.responses[i]]),
                                                r.html(i),
                                                r.show(2e3),
                                ...
                                t = "Submitting...";
                                return (
                                    "en" !== a.language && h.ajaxChimp.translations && h.ajaxChimp.translations[a.language] && h.ajaxChimp.translations[a.language].submit && (t = h.ajaxChimp.translations[a.language].submit),
                                    r.html(t).show(2e3),
                                    !1
                                );
                            });
    ...
    (function (e) {
        ...
        e.fn.counterUp = function (t) {
            var p,
                f = e.extend({ time: 400, delay: 10, offset: 100, beginAt: 0, formatter: !1, context: "window", callback: function () {} }, t);
            return this.each(function () {
                var u = e(this),
                    d = {
                        time: e(this).data("counterup-time") || f.time,
                        delay: e(this).data("counterup-delay") || f.delay,
                        offset: e(this).data("counterup-offset") || f.offset,
                        beginAt: e(this).data("counterup-beginat") || f.beginAt,
                        context: e(this).data("counterup-context") || f.context,
                    };
                u.waypoint(
                    function (t) {
                        !(function () {
                            var t = [],
                                e = d.time / d.delay,
                                i = u.attr("data-num") ? u.attr("data-num") : u.text(),
                                s = /[0-9]+,[0-9]+/.test(i),
                                n = ((i = i.replace(/,/g, "")).split(".")[1] || []).length;
                            d.beginAt > i && (d.beginAt = i);
                            var o = /[0-9]+:[0-9]+:[0-9]+/.test(i);
                            if (o) {
                                var r = i.split(":"),
                                    a = 1;
                                for (p = 0; 0 < r.length; ) (p += a * parseInt(r.pop(), 10)), (a *= 60);
                            }
                            for (var l = e; l >= (d.beginAt / i) * e; l--) {
                                var h,
                                    c = parseFloat((i / e) * l).toFixed(n);
                                if (
                                    (o &&
                                        ((c = parseInt((p / e) * l)),
                                        (c = ((h = parseInt(c / 3600) % 24) < 10 ? "0" + h : h) + ":" + ((h = parseInt(c / 60) % 60) < 10 ? "0" + h : h) + ":" + ((h = parseInt(c % 60, 10)) < 10 ? "0" + h : h))),
                                    s)
                                )
                                    for (; /(\d+)(\d{3})/.test(c.toString()); ) c = c.toString().replace(/(\d+)(\d{3})/, "$1,$2");
                                f.formatter && (c = f.formatter.call(this, c)), t.unshift(c);
                            }
                            u.data("counterup-nums", t), u.text(d.beginAt);
                            u.data("counterup-func", function () {
                                u.data("counterup-nums")
                                    ? (u.html(u.data("counterup-nums").shift()),
                                      u.data("counterup-nums").length ? setTimeout(u.data("counterup-func"), d.delay) : (u.data("counterup-nums", null), u.data("counterup-func", null), f.callback.call(this)))
    ...
    (function (t) {
        ...
        (t.prototype = {
            ...
            open: function (t) {
                ...
                if (!f.isOpen) {
                    (f.types = []),
                        ...
                        f.bgOverlay ||
                            ((f.bgOverlay = u("bg").on("click" + b, function () {
                                f.close();
                            })),
                            (f.wrap = u("wrap")
                                .attr("tabindex", -1)
            ...
            _close: function () {
                ...
                f.bgOverlay.detach(),
                    ...
                    f.fixedContentPos && ((t = { marginRight: "" }), f.isIE7 ? h("body, html").css("overflow", "") : (t.overflow = ""), h("html").css(t)),
            ...
            updateItemHTML: function () {
                ...
                d("BeforeChange", [f.currItem ? f.currItem.type : "", e]),
                    (f.currItem = t),
                    f.currTemplate[e] || ((i = !!f.st[e] && f.st[e].markup), d("FirstMarkupParse", i), (f.currTemplate[e] = !i || h(i))),
                    ...
                    "string" == typeof t
                        ? "open" === t
                            ? ((e = a ? n.data("magnificPopup") : n[0].magnificPopup),
                              ...
                              (s = e.items ? e.items[i] : ((s = n), (s = e.delegate ? s.find(e.delegate) : s).eq(i))),
                              f._openClick({ mfpEl: s }, n, e))
                            : f.isOpen && f[t].apply(f, Array.prototype.slice.call(arguments, 1))
                        : ((t = h.extend(!0, {}, t)), a ? n.data("magnificPopup", t) : (n[0].magnificPopup = t), f.addGroup(n, t)),
                    n
                );
            });
        function C() {
            ...
            proto: {
                ...
                getInline: function (t, e) {
                    if ((C(), t.src)) {
                        ...
                        return (
                            n.length
                                ? ((i = n[0].parentNode) && i.tagName && (T || ((E = s.hiddenClass), (T = u(E)), (E = "mfp-" + E)), (k = n.after(T).detach().removeClass(E))), f.updateStatus("ready"))
        ...
        h.magnificPopup.registerModule(L, {
            ...
            proto: {
                initAjax: function () {
                    f.types.push(L), (I = f.st.ajax.cursor), c(l + "." + L, O), c("BeforeChange." + L, O);
                },
                getAjax: function (s) {
                    ...
                    var t = h.extend(
                        {
                            ...
                            error: function () {
                                A(), (s.finished = s.loadError = !0), f.updateStatus("error", f.st.ajax.tError.replace("%url%", s.src));
                            },
                        },
                        f.st.ajax.settings
                    );
        ...
        h.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                _onImageHasSize: function (t) {
                    t.img && ((t.hasSize = !0), z && clearInterval(z), (t.isCheckingImgSize = !1), d("ImageHasSize", t), t.imgHidden && (f.content && f.content.removeClass("mfp-loading"), (t.imgHidden = !1)));
                },
                ...
                getImage: function (t, e) {
                    ...
                    return (
                        ...
                        f.resizeImage(),
                        t.hasSize
                            ? (z && clearInterval(z), t.loadError ? (e.addClass("mfp-loading"), f.updateStatus("error", r.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), f.updateStatus("ready")))
        ...
        h.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function (t) {
                    ...
                    return (D = void 0 === D ? void 0 !== document.createElement("p").style.MozTransform : D) ? (s["-moz-transform"] = s.transform = "translate(" + i.left + "px," + i.top + "px)") : ((s.left = i.left), (s.top = i.top)), s;
                },
            },
        });
        function M(t) {
                    ...
                    return (
                        ...
                        !(!o || !o.enabled) &&
                            ...
                            c(_ + t, function (t, e, i, s) {
                                ...
                                i.counter = 1 < n ? N(o.tCounter, s.index, n) : "";
                            }),
                            c("BuildControls" + t, function () {
                                ...
                                1 < f.items.length &&
                                    ...
                                    !f.arrowLeft &&
                                    ((e = o.arrowMarkup),
                                    (t = f.arrowLeft = h(e.replace(/%title%/gi, o.tPrev).replace(/%dir%/gi, "left")).addClass(r)),
                                    (e = f.arrowRight = h(e.replace(/%title%/gi, o.tNext).replace(/%dir%/gi, "right")).addClass(r)),
                                    t.click(function () {
                                        f.prev();
                                    }),
                                    e.click(function () {
        ...
        c.extend(c.fn, {
            validate: function (t) {
                if (this.length) {
                    ...
                    return (
                        ...
                        (s = new c.validator(t, this[0])),
                        c.data(this[0], "validator", s),
                        s.settings.onsubmit &&
                            (this.on("click.validate", ":submit", function (t) {
                                (s.submitButton = t.currentTarget), c(this).hasClass("cancel") && (s.cancelSubmit = !0), void 0 !== c(this).attr("formnovalidate") && (s.cancelSubmit = !0);
                            }),
                            this.on("submit.validate", function (i) {
                                function t() {
                                    var t, e;
                                    return (
                                        s.submitButton && (s.settings.submitHandler || s.formSubmitted) && (t = c("<input type='hidden'/>").attr("name", s.submitButton.name).val(c(s.submitButton).val()).appendTo(s.currentForm)),
            ...
            rules: function (t, e) {
                ...
                if (null != a && (!a.form && l && ((a.form = this.closest("form")[0]), (a.name = this.attr("name"))), null != a.form)) {
                    if (t)
                        switch (((i = c.data(a.form, "validator").settings), (s = i.rules), (n = c.validator.staticRules(a)), t)) {
                            case "add":
                                c.extend(n, c.validator.normalizeRule(e)), delete n.messages, (s[a.name] = n), e.messages && (i.messages[a.name] = c.extend(i.messages[a.name], e.messages));
                                break;
                            case "remove":
                                return e
                                    ? ((r = {}),
                    ...
                    return (
                        (t = c.validator.normalizeRules(c.extend({}, c.validator.classRules(a), c.validator.attributeRules(a), c.validator.dataRules(a), c.validator.staticRules(a)), a)).required &&
                            ((o = t.required), delete t.required, (t = c.extend({ required: o }, t))),
                        t.remote && ((o = t.remote), delete t.remote, (t = c.extend(t, { remote: o }))),
                        t
                    );
                }
            },
            ...
            (c.validator.format = function (i, t) {
                return 1 === arguments.length
                    ...
                    : (void 0 === t ||
                          ((t = 2 < arguments.length && t.constructor !== Array ? c.makeArray(arguments).slice(1) : t).constructor !== Array && (t = [t]),
                          c.each(t, function (t, e) {
            ...
            c.extend(c.validator, {
                ...
                prototype: {
                    init: function () {
                        function t(t) {
                            var e,
                                i,
                                s = void 0 !== c(this).attr("contenteditable") && "false" !== c(this).attr("contenteditable");
                            !this.form && s && ((this.form = c(this).closest("form")[0]), (this.name = c(this).attr("name"))),
                                n === this.form && ((e = c.data(this.form, "validator")), (i = "on" + t.type.replace(/^validate/, "")), (s = e.settings)[i] && !c(this).is(s.ignore) && s[i].call(e, this, t));
                        }
                        ...
                        return c(this.currentForm)
                            ...
                            .filter(function () {
                                ...
                                return (
                                    ...
                                    !(this.form !== i.currentForm || t in s || !i.objectLength(c(this).rules()) || ((s[t] = !0), 0))
                                );
                            });
                    },
                    clean: function (t) {
                    ...
                    check: function (e) {
                        ...
                        for (i in ("function" == typeof o.normalizer ? (n = o.normalizer) : "function" == typeof this.settings.normalizer && (n = this.settings.normalizer), n && ((l = n.call(e, l)), delete o.normalizer), o)) {
                            s = { method: i, parameters: o[i] };
                            try {
                                if ("dependency-mismatch" === (t = c.validator.methods[i].call(this, l, e, s.parameters)) && 1 === r) {
                                    a = !0;
                                    continue;
                                }
                    ...
                    defaultMessage: function (t, e) {
                        ...
                        var i = this.findDefined(
                            ...
                            s = /\$?\{(\d+)\}/g;
                        return "function" == typeof i ? (i = i.call(this, e.parameters, t)) : s.test(i) && (i = c.validator.format(i.replace(s, "{$1}"), e.parameters)), i;
                    },
                    ...
                    showLabel: function (t, e) {
                        ...
                        o.length
                            ...
                            : ((i = o = c("<" + this.settings.errorElement + ">")
                                  .attr("id", r + "-error")
                              ...
                              o.is("label")
                                  ...
                                  : 0 === o.parents("label[for='" + this.escapeCssMeta(r) + "']").length &&
                                    ...
                                    (s = this.groups[t.name]) &&
                                        ((n = this),
                                        c.each(n.groups, function (t, e) {
                                            e === s && c("[name='" + n.escapeCssMeta(t) + "']", n.currentForm).attr("aria-describedby", o.attr("id"));
                                        })))),
                ...
                attributeRules: function (t) {
                    ...
                    for (e in c.validator.methods) (i = "required" === e ? ((i = t.getAttribute(e)), "" === i && (i = !0), !!i) : n.attr(e)), this.normalizeAttributeRule(s, o, e, i);
                ...
                dataRules: function (t) {
                    var e,
                        ...
                        n = c(t),
                        o = t.getAttribute("type");
                    for (e in c.validator.methods) (i = n.data("rule" + e.charAt(0).toUpperCase() + e.substring(1).toLowerCase())), "" === i && (i = !0), this.normalizeAttributeRule(s, o, e, i);
                    return s;
                },
                ...
                normalizeRules: function (s, n) {
                    return (
                        c.each(s, function (t, e) {
                            if (!1 !== e) {
                                if (e.param || e.depends) {
                                    ...
                                    i ? (s[t] = void 0 === e.param || e.param) : (c.data(n.form, "validator").resetElements(c(n)), delete s[t]);
                                }
                            } else delete s[t];
                        }),
                        c.each(s, function (t, e) {
                            s[t] = c.isFunction(e) && "normalizer" !== t ? e(n) : e;
                        }),
                        ...
                        c.each(["rangelength", "range"], function () {
                            var t;
                            s[this] &&
                                (c.isArray(s[this]) ? (s[this] = [Number(s[this][0]), Number(s[this][1])]) : "string" == typeof s[this] && ((t = s[this].replace(/[\[\]]/g, "").split(/[\s,]+/)), (s[this] = [Number(t[0]), Number(t[1])])));
                        }),
                ...
                methods: {
                    ...
                    step: function (t, e, i) {
                        ...
                        return (o = s(i)), (s(t) > o || n(t) % n(i) != 0) && (h = !1), this.optional(e) || h;
                    },
                    ...
                    remote: function (s, n, t, o) {
                        if (this.optional(n)) return "dependency-mismatch";
                        o = ("string" == typeof o && o) || "remote";
                        var r,
                            e,
                            a = this.previousValue(n, o);
                        return (
                            ...
                            (e = c.param(c.extend({ data: s }, t.data))),
                            a.old === e
                                ? a.valid
                                : ((a.old = e),
                                      ...
                                      c.extend(
                                          !0,
                                          {
                                              ...
                                              success: function (t) {
                                                  var e,
                                                      i = !0 === t || "true" === t;
                                                  (r.settings.messages[n.name][o] = a.originalMessage),
                                                      i
                                                          ? ((e = r.formSubmitted), r.resetInternals(), (r.toHide = r.errorsFor(n)), (r.formSubmitted = e), r.successList.push(n), (r.invalid[n.name] = !1), r.showErrors())
                                                          : ((e = {}), (t = t || r.defaultMessage(n, { method: o, parameters: s })), (e[n.name] = a.message = t), (r.invalid[n.name] = !0), r.showErrors(e)),
                                                      (a.valid = i),
                                                      r.stopRequest(n, i);
                                              },
                                          },
                ...
                (t = {
                    ...
                    for (o in this.waypoints[e]) {
                        ...
                        l.element !== l.element.window && (u = l.adapter.offset()[r.offsetProp]),
                            "function" == typeof h ? (h = h.apply(l)) : "string" == typeof h && ((h = parseFloat(h)), -1 < l.options.offset.indexOf("%") && (h = Math.ceil((r.contextDimension * h) / 100))),
                            (a = r.contextScroll - r.contextOffset),
                            (l.triggerPoint = Math.floor(u + a - h)),
                            (a = c < r.oldScroll),
                            (h = l.triggerPoint >= r.oldScroll),
                            (c = !a && !h),
                            !d && a && h ? (l.queueTrigger(r.backward), (n[l.group.id] = l.group)) : ((!d && c) || (d && r.oldScroll >= l.triggerPoint)) && (l.queueTrigger(r.forward), (n[l.group.id] = l.group));
                    }
                }
                return (
        ...
        (h.Defaults = {
            ...
            (h.prototype.to = function (t, e) {
                var i,
                    ...
                    l = this.maximum();
                this.settings.loop
                    ? (!this.settings.rewind && Math.abs(n) > r / 2 && (n += -1 * o * r), (i = (((((t = s + n) - a) % r) + r) % r) + a) !== t && i - n <= l && 0 < i - n && ((s = i - n), (t = i), this.reset(s)))
    ...
    (function (n, o) {
        ...
        !(function () {
            ...
            s() && ((n.support.transform = new String(t("transform"))), (n.support.transform3d = l()));
    ...
    (function (s) {
                ...
                (this._handlers = {
                    "prepared.owl.carousel": s.proxy(function (t) {
                        ...
                        !t.namespace || !this.owl.options.thumbs || this.owl.options.thumbImage || this.owl.options.thumbsPrerendered || this.owl.options.thumbImage
                            ? t.namespace && this.owl.options.thumbs && this.owl.options.thumbImage && ((e = s(t.content).find("img")), this._thumbcontent.push(e))
                            : void 0 !== s(t.content).find("[data-thumb]").attr("data-thumb") && this._thumbcontent.push(s(t.content).find("[data-thumb]").attr("data-thumb"));
                    }, this),
                    "initialized.owl.carousel": s.proxy(function (t) {
        ...
        (e.Defaults = { thumbs: !0, thumbImage: !1, thumbContainerClass: "owl-thumbs", thumbItemClass: "owl-thumb-item", moveThumbsInside: !1 }),
            ...
            (e.prototype.render = function () {
                ...
                if (
                    (e.thumbsPrerendered
                        ? ((this._thumbcontent._thumbcontainer = s("." + e.thumbContainerClass)), e.moveThumbsInside && this._thumbcontent._thumbcontainer.appendTo(this.$element))
                        : (this._thumbcontent._thumbcontainer = s("<div>").addClass(e.thumbContainerClass).appendTo(this.$element)),
                    e.thumbImage)
                )
    ...
    (function (t, e) {
        ...
        var r = function (t, e, i) {
            ...
            a =
                ...
                d),
            l = window.MutationObserver || window.WebkitMutationObserver || window.MozMutationObserver || (r(u, [{ key: "observe", value: function () {} }]), (u.notSupported = !0), u),
            h =
                                ...
                                this.config.live &&
                                    new l(function (t) {
                                        for (var e = 0; e < t.length; e++)
                                            for (var i = t[e], s = 0; s < i.addedNodes.length; s++) {
                        ...
                        value: function (t) {
                            return (
                                ...
                                this.config.resetAnimation &&
                                    (s(t, "animationend", this.resetAnimation), s(t, "oanimationend", this.resetAnimation), s(t, "webkitAnimationEnd", this.resetAnimation), s(t, "MSAnimationEnd", this.resetAnimation)),
                                t
                            );
                            var e, i;
                        },
        ...
        function c() {
            ...
            i(this, c),
                ...
                (this.wowEvent = (function (t, e, i, s) {
                    var n = !(arguments.length <= 1 || void 0 === e) && e,
                        e = !(arguments.length <= 2 || void 0 === i) && i,
                        i = arguments.length <= 3 || void 0 === s ? null : s,
                        s = void 0;
                    return (
                        null != document.createEvent ? (s = document.createEvent("CustomEvent")).initCustomEvent(t, n, e, i) : null != document.createEventObject ? ((s = document.createEventObject()).eventType = t) : (s.eventName = t), s
                    );
